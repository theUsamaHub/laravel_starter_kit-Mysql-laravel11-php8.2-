                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <x-text-input id="published_at" name="published_at" type="datetime-local" class="form-control" :value="old('published_at', $category->published_at?->format('Y-m-d\TH:i'))" />
                                    <small class="text-muted">{{ __('Leave empty to publish immediately.') }}</small>
                                </div>
                                <div class="col-md-6">
                                    <x-input-label for="unpublish_at" :value="__('Unpublish At')" />
                                    <x-text-input id="unpublish_at" name="unpublish_at" type="datetime-local" class="form-control" :value="old('unpublish_at', $category->unpublish_at?->format('Y-m-d\TH:i'))" />
